...
<div class="liquid-nav">
    <a href="?nav=executive">📈 Executive Summary</a>
    <a href="?nav=matrix">⚖️ Partner Matrix</a>
    <div class="nav-center">
        <img src="https://www.aswinicalicut.net/assets/img/logo/logo.png" alt="Aswini Logo">
    </div>
    <a href="?nav=forecast">🔮 Forecast</a>
    <a href="?nav=team">👨‍💻 Application Team</a>
